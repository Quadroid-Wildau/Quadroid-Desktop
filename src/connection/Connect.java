...
{
	private Logger logger = LoggerFactory.getLogger(Connect.class.getName());
	...
	/**
	 * This function return an {@link List} contains all available 
	 * {@link SerialPort}
	 * 
	 * @return get an {@link List} contains Strings for 
	 * SerialPort description if no SerialPort available 
	...
	public static List<String> getAvailablePorts()
	{
		...
		while(ports.hasMoreElements())
		{
			...
			/*if an SerialPort and not in use add to portlist*/
